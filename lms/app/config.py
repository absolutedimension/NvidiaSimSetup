...
class Settings:
    ...
    TEACHER_COACHING_INR = int(os.getenv("TEACHER_COACHING_INR", "2999")) # <=50 students, class analytics + priority
    TEACHER_INSTITUTE_INR = int(os.getenv("TEACHER_INSTITUTE_INR", "7999"))  # <=200 students, multi-teacher + priority support. Logo/full branding = Custom tier (200+, contact us) ONLY
