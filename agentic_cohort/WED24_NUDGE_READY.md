# Wed-24 Jun nudge — READY TO SEND (Agentic Cohort 1)

> Prepared Mon 22 Jun. **Send Wednesday 24 Jun** to anyone of the 3 who hasn't transferred yet.
...
## If anyone hesitates (Message C — and WRITE THE OBJECTION DOWN)
Ask one question, don't reflex-discount:
> "Totally fair — what's the hesitation? Is it the timing, the price, or not sure it'll work for *your* kind of work?"

Log each objection here as it comes in — three honest objections this week are worth more than three silent maybes:
- Aditya:
- Kritansh:
- Gauri:

## The moment one clears
Same day: send Discord invite + `Cohort1_Start_Here.zip`, and tell the CEO OS so the briefing flips off "0 paid." Use honest scarcity on the rest: "2 seats taken, 1 left."
