...
HOME="/home/ubuntu"; B=f"{HOME}/youtube_series/ep07_manim_hi_build"; BUILD=f"{HOME}/youtube_series/ep07_hi_build"
OUT=f"{HOME}/youtube_series/ep07_hi_FINAL.mp4"; N=12

print("== STEP 1: render Hindi scenes (boomerang bg) ==",flush=True)
subprocess.run(["python3","render_ep07_manim_hi.py"],cwd=HOME)
