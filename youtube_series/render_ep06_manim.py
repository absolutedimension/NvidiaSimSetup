#!/usr/bin/env python3
"""EN Ep3 driver: ep06_manim.py + contextual bg_ep06 clips + logo finish.
Usage: python3 render_ep06_manim.py [all|6,7]"""
import os, sys, glob, subprocess
HOME="/home/ubuntu"
BUILD=f"{HOME}/youtube_series/ep06_build"
CLIPDIR=f"{HOME}/youtube_series/clips"
WORK=f"{HOME}/youtube_series/ep06_manim_build"; os.makedirs(WORK, exist_ok=True)
SPIN=f"{HOME}/youtube_series/assets/trigun_spin_1080.mp4"
W,H,FPS=1920,1080,30
ALLBG={i:f"bg_ep06_s{i:02d}_boom.mp4" for i in range(1,13)}
LOGO_SCENE=12
ENGINE="ep06_manim.py"; MEDIA="ep06_manim"
