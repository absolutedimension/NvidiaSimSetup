#!/usr/bin/env python3
"""HINDI Ep3 driver: ep04_manim_hi.py (Devanagari) + SAME bg_ep04 clips + logo finish.
Usage: python3 render_ep04_manim_hi.py [all|6,7]"""
import os, sys, glob, subprocess
HOME="/home/ubuntu"
BUILD=f"{HOME}/youtube_series/ep04_hi_build"
CLIPDIR=f"{HOME}/youtube_series/clips"
WORK=f"{HOME}/youtube_series/ep04_manim_hi_build"; os.makedirs(WORK, exist_ok=True)
SPIN=f"{HOME}/youtube_series/assets/trigun_spin_1080.mp4"
W,H,FPS=1920,1080,30
ALLBG={i:f"bg_ep04_s{i:02d}_boom.mp4" for i in range(1,13)}
LOGO_SCENE=12; ENGINE="ep04_manim_hi.py"; MEDIA="ep04_manim_hi"
