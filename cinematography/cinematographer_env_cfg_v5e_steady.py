"""Isaac Lab env config v5e: STEADY cinematographer drone — improved stability."""
...
@configclass
class CinematographerEnvCfgV5eSteady(DirectRLEnvCfg):
    """v5e STEADY: 20-dim obs, improved reward balance + stable training.

    Same observation layout as v5d (backward compatible ONNX):
    ...
    # Starling 2 physics (unchanged from v5d)
