...
2. Check `project_hub/feedback/*_to_vr*.md` for unread messages from Training Agent
...
2. Write feedback files to `project_hub/feedback/` for Training Agent (test results, verdicts)
3. Update `project_hub/ARTIFACT_REGISTRY.md` with any new GLBs integrated or APKs built
4. If a gate was reached (VR test verdict), add to `project_hub/GATE_LOG.md`
