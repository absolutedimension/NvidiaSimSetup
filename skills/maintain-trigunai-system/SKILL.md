...
- **lms = v64** · **triguai-frontend = v107** (bump from these). ⚠️ tag-reuse gotcha: a stale `lms:v62`
...
- **Acharya for STUDENTS — `/exam-prep` SHIPPED (Phase 1, lms:v64, 2026-07-22):** a self-serve student
  ...
  Roadmap: P2 dynamic LLM test-gen, P3 parallel ₹199 billing track, P4 Google Ads. Full plan + decisions:
