...
- **lms = v65** · **triguai-frontend = v107** (bump from these). ⚠️ tag-reuse gotcha: a stale `lms:v62`
...
- **Acharya for STUDENTS — `/exam-prep` SHIPPED (Phase 1, lms:v64, 2026-07-22):** a self-serve student
  ...
  P2 dynamic LLM test-gen (free-text ANY exam → generate+key-withheld-validate+cache, `assess_gen.py` + `AssessmentItem` + `/api/assess/generate`) SHIPPED lms:v65. Roadmap left: P3 parallel ₹199 billing track, P4 Google Ads. Full plan + decisions:
