#!/usr/bin/env python3
"""Build REVISIT_LADDER.pdf — a printable field visit sheet from the .md.
...
MD   = HERE / "REVISIT_LADDER.md"
HTML = pathlib.Path("/tmp/revisit_ladder.html")
PDF  = HERE / "REVISIT_LADDER.pdf"
...
<html><head>
<meta charset="utf-8">
<title>Acharya — The Revisit Ladder</title>
<style>
