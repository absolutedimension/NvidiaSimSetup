#!/usr/bin/env python3
"""Build HEENA_CALL_LIST_PATNA.pdf — a printable field visit sheet from the .md.
...
MD   = HERE / "HEENA_CALL_LIST_PATNA.md"
HTML = pathlib.Path("/tmp/heena_calls.html")
PDF  = HERE / "HEENA_CALL_LIST_PATNA.pdf"
...
<html><head>
<meta charset="utf-8">
<title>Acharya — Heena Patna Call List</title>
<style>
