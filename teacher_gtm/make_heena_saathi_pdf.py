#!/usr/bin/env python3
"""Build HEENA_HOW_TO_USE_SAATHI.pdf — a printable field visit sheet from the .md.
...
MD   = HERE / "HEENA_HOW_TO_USE_SAATHI.md"
HTML = pathlib.Path("/tmp/heena_saathi.html")
PDF  = HERE / "HEENA_HOW_TO_USE_SAATHI.pdf"
...
<html><head>
<meta charset="utf-8">
<title>Saathi — How to use it</title>
<style>
