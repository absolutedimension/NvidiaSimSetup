#!/usr/bin/env python3
"""Build ROHAN_VISIT_LIST_5.pdf — a printable field visit sheet from the .md.
...
MD   = HERE / "ROHAN_VISIT_LIST_5.md"
HTML = pathlib.Path("/tmp/rohan_visit_list.html")
PDF  = HERE / "ROHAN_VISIT_LIST_5.pdf"
...
<html><head>
<meta charset="utf-8">
<title>Acharya — Field Visit List for Rohan</title>
<style>
...
<body>
""" + body_html + """
<div class="footer">TrigunAI Innovations &middot; Acharya Field Visit List &middot; Rohan &middot; Confidential &middot; 2026-08-17</div>
</body></html>"""
