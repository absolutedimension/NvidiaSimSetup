#!/usr/bin/env python3
"""Build HEENA_CALL_SCRIPTS.pdf — a printable field visit sheet from the .md.
...
MD   = HERE / "HEENA_CALL_SCRIPTS.md"
HTML = pathlib.Path("/tmp/heena_scripts.html")
PDF  = HERE / "HEENA_CALL_SCRIPTS.pdf"
...
<html><head>
<meta charset="utf-8">
<title>Acharya — Heena Call Scripts</title>
<style>
