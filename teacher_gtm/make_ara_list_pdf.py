#!/usr/bin/env python3
"""Build ARA_INSTITUTE_LIST.pdf — a printable field visit sheet from the .md.
...
MD   = HERE / "ARA_INSTITUTE_LIST.md"
HTML = pathlib.Path("/tmp/ara_institute_list.html")
PDF  = HERE / "ARA_INSTITUTE_LIST.pdf"
...
<html><head>
<meta charset="utf-8">
<title>Acharya — Ara Institute List for Priyanshu</title>
<style>
